  ...
  public static void build(String[] args) {
    ...
    for (String chunk : chunks) {
      ...
      FileOutputStream outputStream;
        try {
            outputStream = new FileOutputStream("BinaryDataset.txt");
             PrintWriter printWriter = new PrintWriter(outputStream);
             printWriter.print(collapsedUnary.toString());
             printWriter.close();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(BuildBinarizedDatasetGen.class.getName()).log(Level.SEVERE, null, ex);
        }
